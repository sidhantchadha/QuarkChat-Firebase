...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell.senderUsername.text == (Auth.auth().currentUser?.email as String?) {
            ...
            cell.avatarImageView.image = UIImage(named: "man-17")
            cell.messageBackground.backgroundColor = #colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1)

        } else {
            
            cell.avatarImageView.image = UIImage(named: "man-19")
            cell.messageBackground.backgroundColor = #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        //Creating new reference within database
